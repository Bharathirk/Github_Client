...
//    Log.d("5TAG", "bindFramebuffer: 1"+texture);
//    Log.d("5TAG", "bindFramebuffer: 2"+GLES20.GL_FRAMEBUFFER);
//    Log.d("5TAG", "bindFramebuffer: 3"+GLES20.GL_COLOR_ATTACHMENT0);
//    Log.d("5TAG", "bindFramebuffer: 4"+GLES20.GL_TEXTURE_2D);
//    Log.d("5TAG", "bindFramebuffer: 5"+height);
//    Log.d("5TAG", "bindFramebuffer: 6"+width);
